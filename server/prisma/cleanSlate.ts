 ...
 *
 * Kept: logins, roles and their permissions, currencies, units, attributes, cost formulas,
 * stage lines, container types, trades, holidays, workforce settings, statutory components
 * and app settings — that is setup.
...
async function main() {
  ...
  console.log('Config preserved: users, roles, currencies, units, attributes, cost formulas,');
